...
public class RSA {
    ...
    public static PublicKey initFromStrings(String s) throws NoSuchAlgorithmException, InvalidKeySpecException {
            X509EncodedKeySpec keySpecPublic = new X509EncodedKeySpec(decode(s));
            KeyFactory keyFactory = KeyFactory.getInstance("RSA");
            PublicKey publicKey1 = keyFactory.generatePublic(keySpecPublic);
            return publicKey1;
    }
